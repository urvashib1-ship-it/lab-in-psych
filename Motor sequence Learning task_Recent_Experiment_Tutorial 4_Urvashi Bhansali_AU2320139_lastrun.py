...
expName = 'Motor sequence Learning task_Recent_Experiment_Tutorial 4_Urvashi Bhansali_AU2320139'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/urvashibhansali/Documents/AU (1-4 years) /3rd Year/Semester 5 Monsoon 25-26/PSY310/Psychopy/Youtube Psychopy Tutorials/Motor Sequence Learning Task (4)/Motor sequence Learning task_Recent_Experiment_Tutorial 4_Urvashi Bhansali_AU2320139_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Fixation = visual.ShapeStim(
        ...
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor=(-1.0000, 0.0902, 0.0902),
    ...
    protrianglefixation = visual.ShapeStim(
        win=win, name='protrianglefixation',units='pix', 
    ...
    Fixation_2 = visual.ShapeStim(
        ...
        opacity=None, depth=0.0, interpolate=True)
    line1_2 = visual.Rect(
        win=win, name='line1_2',units='pix', 
        width=(100, 10)[0], height=(100, 10)[1],
        ori=90.0, pos=(-150, 0), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
        opacity=None, depth=-1.0, interpolate=True)
    line2_2 = visual.Rect(
        win=win, name='line2_2',units='pix', 
        width=(100, 10)[0], height=(100, 10)[1],
        ori=90.0, pos=(-50, 0), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
        opacity=None, depth=-2.0, interpolate=True)
    line3_2 = visual.Rect(
        win=win, name='line3_2',units='pix', 
        width=(100, 10)[0], height=(100, 10)[1],
        ori=90.0, pos=(50, 0), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
        opacity=None, depth=-3.0, interpolate=True)
    line4_2 = visual.Rect(
        win=win, name='line4_2',units='pix', 
        width=(100, 10)[0], height=(100, 10)[1],
        ori=90.0, pos=(150, 0), draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
        opacity=None, depth=-4.0, interpolate=True)
    protrianglefixation_2 = visual.ShapeStim(
        win=win, name='protrianglefixation_2',units='pix', 
        size=(10, 10), vertices='triangle',
        ori=0.0, pos=[0,0], draggable=False, anchor='center',
        lineWidth=1.0,
        colorSpace='rgb', lineColor='white', fillColor='white',
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('/Users/urvashibhansali/Documents/AU (1-4 years) /3rd Year/Semester 5 Monsoon 25-26/PSY310/Lab Reports/Motor Sequential Task/Conditions File/Visual variables.csv'), 
        seed=None, 
        isTrials=True, 
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[Fixation, line1, line2, line3, line4, protrianglefixation, key_resp],
        )
        trial.status = NOT_STARTED
        continueRoutine = True
        # update component parameters for each repeat
        protrianglefixation.setPos((pos, 60))
        ...
        while continueRoutine:
            ...
            # *protrianglefixation* updates
            
            # if protrianglefixation is starting this frame...
            if protrianglefixation.status == NOT_STARTED and tThisFlip >= 2.0-frameTolerance:
                # keep track of start time/frame for later
                protrianglefixation.frameNStart = frameN  # exact frame index
                protrianglefixation.tStart = t  # local t and not account for scr refresh
                protrianglefixation.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(protrianglefixation, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'protrianglefixation.started')
                # update status
                protrianglefixation.status = STARTED
                protrianglefixation.setAutoDraw(True)
            
            # if protrianglefixation is active this frame...
            if protrianglefixation.status == STARTED:
                # update params
                pass
    ...
    for thisTrial_2 in trials_2:
        ...
        trial_2 = data.Routine(
            name='trial_2',
            components=[Fixation_2, line1_2, line2_2, line3_2, line4_2, protrianglefixation_2, key_resp_2],
        )
        trial_2.status = NOT_STARTED
        continueRoutine = True
        # update component parameters for each repeat
        protrianglefixation_2.setPos((pos, 60))
        ...
        while continueRoutine:
            ...
            # if line1_2 is starting this frame...
            if line1_2.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
                line1_2.frameNStart = frameN  # exact frame index
                line1_2.tStart = t  # local t and not account for scr refresh
                line1_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(line1_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'line1_2.started')
                # update status
                line1_2.status = STARTED
                line1_2.setAutoDraw(True)
            
            # if line1_2 is active this frame...
            if line1_2.status == STARTED:
                # update params
                pass
            
            # *line2_2* updates
            
            # if line2_2 is starting this frame...
            if line2_2.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
                line2_2.frameNStart = frameN  # exact frame index
                line2_2.tStart = t  # local t and not account for scr refresh
                line2_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(line2_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'line2_2.started')
                # update status
                line2_2.status = STARTED
                line2_2.setAutoDraw(True)
            
            # if line2_2 is active this frame...
            if line2_2.status == STARTED:
                # update params
                pass
            
            # *line3_2* updates
            
            # if line3_2 is starting this frame...
            if line3_2.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
                line3_2.frameNStart = frameN  # exact frame index
                line3_2.tStart = t  # local t and not account for scr refresh
                line3_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(line3_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'line3_2.started')
                # update status
                line3_2.status = STARTED
                line3_2.setAutoDraw(True)
            
            # if line3_2 is active this frame...
            if line3_2.status == STARTED:
                # update params
                pass
            
            # *line4_2* updates
            
            # if line4_2 is starting this frame...
            if line4_2.status == NOT_STARTED and tThisFlip >= 1.0-frameTolerance:
                # keep track of start time/frame for later
                line4_2.frameNStart = frameN  # exact frame index
                line4_2.tStart = t  # local t and not account for scr refresh
                line4_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(line4_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'line4_2.started')
                # update status
                line4_2.status = STARTED
                line4_2.setAutoDraw(True)
            
            # if line4_2 is active this frame...
            if line4_2.status == STARTED:
                # update params
                pass
            
            # *protrianglefixation_2* updates
            
            # if protrianglefixation_2 is starting this frame...
            if protrianglefixation_2.status == NOT_STARTED and tThisFlip >= 2.0-frameTolerance:
                # keep track of start time/frame for later
                protrianglefixation_2.frameNStart = frameN  # exact frame index
                protrianglefixation_2.tStart = t  # local t and not account for scr refresh
                protrianglefixation_2.tStartRefresh = tThisFlipGlobal  # on global time
                win.timeOnFlip(protrianglefixation_2, 'tStartRefresh')  # time at next scr refresh
                # add timestamp to datafile
                thisExp.timestampOnFlip(win, 'protrianglefixation_2.started')
                # update status
                protrianglefixation_2.status = STARTED
                protrianglefixation_2.setAutoDraw(True)
            
            # if protrianglefixation_2 is active this frame...
            if protrianglefixation_2.status == STARTED:
                # update params
                pass
