...
expName = 'Discrimination Orientation task'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/urvashibhansali/Documents/AU (1-4 years) /3rd Year/Semester 5 Monsoon 25-26/Lab in Psychology PSY310/Psychopy/youtube tutorials/Discrimination Orientation Task/Discrimination Orientation task_lastrun.py',
